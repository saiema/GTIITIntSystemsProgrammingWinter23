...
*/
extern natural length(const char * const string);
...
*/
extern boolean equals(const char * const string1, const char * const string2);
...
*/
extern int index_of(const char * const string, const char e);
...
/*
    ...
    returns `-1` if the character does not appear in the string
*/
extern int last_index_of(const char * const string, const char e);
...
*/
extern char * to_lower_case(const char * const string);
...
*/
extern char * to_upper_case(const char * const string);
...
*/
extern char * substring(const char * const string, natural from, natural to);
...
/*
    Creates an `expression` representing a exclusive disjunction (xor) of two other `expression`s.
    Takes two pointers to `expression`s `left` and `right`
    Returns a pointer to a new `expression` representing a xor of `left` and `right`
*/
