...
class Expression(ABC):
    ...
    @staticmethod
    def _recursive_interpretations(interpretations: List[List[Tuple(str, bool)]], variables: List[str]) -> List[List[Tuple(str, bool)]]:
        """
        ...
        previous_interpretations: List[List[Tuple(str, bool)]] = Expression._recursive_interpretations(
    ...
    @abstractmethod
    def variables(self: 'Expression') -> List[str]:
        """
    ...
    @abstractmethod
    def interpretations(self: 'Expression') -> List[Dict[str, bool]]:
        """
