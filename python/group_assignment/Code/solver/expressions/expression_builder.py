...
class ExpressionBuilder:
    ...
    def implicate(self: 'ExpressionBuilder', expr_right: Expression) -> 'ExpressionBuilder':
        """
        Creates an implication with another expression
        :param expr_right: the expression with which to create a new implication
        :return: a new expression builder with an implication of the current expression and `expr_right`
        """
        assert expr_right is not None
        assert self.__expression is not None
        self.__expression = BinaryExpression(self.__expression, expr_right, BinaryOp.IMPLIES)
        return self

    def iff(self: 'ExpressionBuilder', expr_right: Expression) -> 'ExpressionBuilder':
        """
        Creates a biconditional with another expression
        :param expr_right: the expression with which to create a new biconditional
        :return: a new expression builder with a biconditional of the current expression and `expr_right`
        """
        assert expr_right is not None
        assert self.__expression is not None
        self.__expression = BinaryExpression(self.__expression, expr_right, BinaryOp.IFF)
        return self

    def exclusive_disjuction(self: 'ExpressionBuilder', expr_right: Expression) -> 'ExpressionBuilder':
        """
        Creates an exclusive disjunction with another expression
        :param expr_right: the expression with which to create a new exclusive disjunction
        :return: a new expression builder with an exclusive disjunction of the current expression and `expr_right`
        """
        assert expr_right is not None
        assert self.__expression is not None
        self.__expression = BinaryExpression(self.__expression, expr_right, BinaryOp.XOR)
        return self
